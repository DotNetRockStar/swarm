...
// Artwork URLs carry the catalog's version, so server updates invalidate
// exactly without routinely re-fetching unchanged images.
const val DEFAULT_ARTWORK_CACHE_MINUTES = 30 * 24 * 60
